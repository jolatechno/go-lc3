...
/* debuging variable */
var DebugLc3Instructions = false
  ...
  [OP_COUNT]*Lc3Instruction {
    ...
    &Lc3Instruction { /* OP_ADD instruction */
      func(memory interfaces.Memory, regs interfaces.Registers, param uint16) (next bool, err error) {
        ...
        if mode == 1 { /* second param is a value */
            ...
            if DebugLc3Instructions {
              fmt.Printf("OP_ADD dr=%X, r1=%X, imm=%X\n", dr, sr1, immediate) /* debug */
            }
            ...
            if DebugLc3Instructions {
              fmt.Printf("OP_ADD dr=%X, r1=%X, r2=%X\n", dr, sr1, sr2) /* debug */
            }
        }
    ...
    &Lc3Instruction { /* OP_AND instruction */
      func(memory interfaces.Memory, regs interfaces.Registers, param uint16) (next bool, err error) {
        ...
        r1 := readReg(regs, sr1) /* read first register */
          ...
          if DebugLc3Instructions {
            fmt.Printf("OP_AND dr=%X, r1=%X, imm=%X\n", dr, sr1, imm5) /* debug */
          }
  			} else {
  				sr2 := param & 0x7
          r2 := readReg(regs, sr2) /* read second register */
  				res = r1 & r2 /* compute value */
          if DebugLc3Instructions {
            fmt.Printf("OP_AND dr=%X, r1=%X, sr2=%X\n", dr, sr1, sr2) /* debug */
          }
  			}
    ...
    &Lc3Instruction { /* OP_LDR instruction */
      func(memory interfaces.Memory, regs interfaces.Registers, param uint16) (next bool, err error) {
        ...
        if DebugLc3Instructions {
          fmt.Printf("OP_LDR dr=%X, r1=%X, off=%X\n", dr, sr1, offset) /* debug */
        }
    ...
    &Lc3Instruction { /* OP_STR instruction */
      func(memory interfaces.Memory, regs interfaces.Registers, param uint16) (next bool, err error) {
        ...
        if DebugLc3Instructions {
          fmt.Printf("OP_STR sr1=%X, sr2=%X, off=%X\n", sr1, sr2, offset) /* debug */
        }
    ...
    &Lc3Instruction { /* OP_TRAP instruction */
      func(memory interfaces.Memory, regs interfaces.Registers, param uint16) (next bool, err error) {
        ...
        case TRAP_GETC:
          ...
          if DebugLc3Instructions {
            fmt.Printf("OP_TRAP TRAP_GETC c=%c\n", c) /* debug */
          }
        ...
        case TRAP_IN:
          ...
          if DebugLc3Instructions {
            fmt.Printf("OP_TRAP TRAP_IN c=%c\n", c) /* debug */
          }
        ...
        case TRAP_HALT:
          ...
          if DebugLc3Instructions {
            fmt.Println("OP_TRAP TRAP_HALT") /* debug */
          }
